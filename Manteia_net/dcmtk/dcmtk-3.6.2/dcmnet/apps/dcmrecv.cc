...
int main(int argc, char *argv[])
{
    ...
    const char *opt_configFile = "E://lanliangsheng//dcmtk//dcmtk-3.6.2//dcmnet//etc//storescp.cfg";//NULL;
	const char *opt_profileName = "AllDICOM";//NULL;
    const char *opt_aeTitle = APPLICATIONTITLE;
    const char *opt_outputDirectory = "E://DcmScuScp//DcmScp";//".";
    const char *opt_filenameExtension = "";

	OFCmdUnsignedInt opt_port = 8888;//0;

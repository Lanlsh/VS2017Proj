...
#define PEERAPPLICATIONTITLE    "LANDCMRECV"//"ANY-SCP"
...
OFCmdUnsignedInt  opt_retrievePort = 999;//0;
...
int               opt_acse_timeout = 30;//30;
OFBool            opt_ignorePendingDatasets = OFTrue;
OFString          opt_outputDirectory = "E://DcmScuScp//DcmCMOVE";//".";
...
int main(int argc, char *argv[])
{
  ...
  OFCmdUnsignedInt opt_port = 8888;//104;
  ...
  OFString str_1 = "E://DcmScuScp//files//0.dcm";//"E://DcmScuScp//DcmScp//0.dcm";//"0.dcm";
  fileNameList.push_back(str_1);
  //str_1 = "E://DcmScuScp//DcmScp//1.dcm";
  //fileNameList.push_back(str_1);
...
moveSCU(T_ASC_Association *assoc, const char *fname)
{
 ...
 /*   OFLOG_INFO(movescuLogger, "Request Identifiers:" << OFendl << DcmObject::PrintHelper(*dcmff.getDataset()));*/
	...
	query.putAndInsertOFStringArray(DCM_PatientID, OFString("ANON98541"));
	OFLOG_INFO(movescuLogger, "Request Identifiers:" << OFendl << DcmObject::PrintHelper(query));

    OFCondition cond = DIMSE_moveUser(assoc, presId, &req, &query/*dcmff.getDataset()*/,
        moveCallback, &callbackData, opt_blockMode, opt_dimse_timeout, net, NULL/*subOpCallback*/,

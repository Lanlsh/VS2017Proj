...
DcmSCPConfig& CSCPBase::getConfig()
{
	return *m_cfg;
}
...
OFCondition CSCPBase::setConfig(const DcmSCPConfig& config)
{
	if (isConnected())
	{
...
void CSCPBase::findPresentationContext(const T_ASC_PresentationContextID presID,
...
DUL_PRESENTATIONCONTEXT* CSCPBase::findPresentationContextID(LST_HEAD *head,
...
void CSCPBase::refuseAssociation(const DcmRefuseReasonType reason)
{
	if (m_assoc == NULL)
	{
		DCMNET_WARN("CSCPBase::refuseAssociation() called but actually no association running, ignoring");
		return;
	}
...
OFCondition CSCPBase::waitForAssociationRQ(T_ASC_Network *network)
{
	if (network == NULL)
		return ASC_NULLKEY;
	if (m_assoc != NULL)
...
OFCondition CSCPBase::processAssociationRQ()
{
...
OFCondition CSCPBase::negotiateAssociation()
{
...
OFCondition CSCPBase::abortAssociation()
{
	...
	if (isConnected())
	{
		...
		DCMNET_WARN("CSCPBase::abortAssociation() called but SCP actually has no association running, ignoring");
	return cond;
}

// ----------------------------------------------------------------------------

void CSCPBase::handleAssociation()
{
	if (m_assoc == NULL)
	{
		DCMNET_WARN("CSCPBase::handleAssociation() called but SCP actually has no association running, ignoring");
		return;
	}
	...
	{
		notifyReleaseRequest(message.CommandField);
...
OFCondition CSCPBase::handleIncomingCommand(T_DIMSE_Message *incomingMsg,
...
OFCondition CSCPBase::handleECHORequest(T_DIMSE_C_EchoRQ &reqMessage,
...
OFCondition CSCPBase::handleSTORERequest(T_DIMSE_C_StoreRQ &reqMessage,
	const T_ASC_PresentationContextID presID,
...
OFCondition CSCPBase::receiveSTORERequest(T_DIMSE_C_StoreRQ &reqMessage,
	const T_ASC_PresentationContextID presID,
	DcmDataset *&reqDataset)
{
...
OFCondition CSCPBase::sendSTOREResponse(const T_ASC_PresentationContextID presID,
...
Uint16 CSCPBase::checkSTORERequest(T_DIMSE_C_StoreRQ & /*reqMessage*/,
	DcmDataset * /*reqDataset*/)
{
...
OFCondition CSCPBase::receiveFINDRequest(T_DIMSE_C_FindRQ &reqMessage,
	const T_ASC_PresentationContextID presID,
	DcmDataset *&reqDataset)
{
	// Do some basic validity checks
...
OFCondition CSCPBase::sendFINDResponse(const T_ASC_PresentationContextID presID,
	const Uint16 messageID,
	const OFString &sopClassUID,
...
OFCondition CSCPBase::checkForCANCEL(T_ASC_PresentationContextID presID,
	const Uint16 messageID)
{
...
OFCondition CSCPBase::receiveMOVERequest(T_DIMSE_C_MoveRQ &reqMessage,
	const T_ASC_PresentationContextID presID,
	DcmDataset *&reqDataset,
	OFString &moveDest)
{
...
OFCondition CSCPBase::sendMOVEResponse(const T_ASC_PresentationContextID presID,
	const Uint16 messageID,
	const OFString &sopClassUID,
	DcmDataset *rspDataset,
	const Uint16 rspStatusCode,
...
OFCondition CSCPBase::receiveACTIONRequest(T_DIMSE_N_ActionRQ &reqMessage,
	const T_ASC_PresentationContextID presID,
	DcmDataset *&reqDataset,
	Uint16 &actionTypeID)
{
...
OFCondition CSCPBase::sendACTIONResponse(const T_ASC_PresentationContextID presID,
	const Uint16 messageID,
	const OFString &sopClassUID,
	const OFString &sopInstanceUID,
	const Uint16 rspStatusCode)
...
OFCondition CSCPBase::handleEVENTREPORTRequest(T_DIMSE_N_EventReportRQ &reqMessage,
	const T_ASC_PresentationContextID presID,
	DcmDataset *&reqDataset,
	Uint16 &eventTypeID)
{
...
OFCondition CSCPBase::sendEVENTREPORTRequest(const T_ASC_PresentationContextID presID,
	const OFString &sopInstanceUID,
	const Uint16 messageID,
...
Uint16 CSCPBase::checkEVENTREPORTRequest(T_DIMSE_N_EventReportRQ & /*reqMessage*/,
	DcmDataset * /*reqDataset*/)
{
	// we default to success
	return STATUS_Success;
...
void CSCPBase::notifySENDProgress(const unsigned long byteCount)
{
	DCMNET_TRACE("Bytes sent: " << byteCount);
}


void CSCPBase::notifyRECEIVEProgress(const unsigned long byteCount)
{
...
OFCondition CSCPBase::sendDIMSEMessage(const T_ASC_PresentationContextID presID,
	T_DIMSE_Message *message,
...
OFCondition CSCPBase::receiveDIMSECommand(T_ASC_PresentationContextID *presID,
	T_DIMSE_Message *message,
	DcmDataset **statusDetail,
	DcmDataset **commandSet,
...
OFCondition CSCPBase::receiveDIMSEDataset(T_ASC_PresentationContextID *presID,
	DcmDataset **dataObject)
{
	if (m_assoc == NULL)
		return DIMSE_ILLEGALASSOCIATION;
...
OFCondition CSCPBase::receiveSTORERequestDataset(T_ASC_PresentationContextID *presID,
...
OFBool CSCPBase::addStatusDetail(DcmDataset **statusDetail,
...
void CSCPBase::forceAssociationRefuse(const OFBool doRefuse)
{
...
void CSCPBase::setMaxReceivePDULength(const Uint32 maxRecPDU)
{
...
OFCondition CSCPBase::setEnableVerification(const OFString &profile)
{
...
OFCondition CSCPBase::addPresentationContext(const OFString &abstractSyntax,
...
void CSCPBase::setPort(const Uint16 port)
{
	m_cfg->setPort(port);
}
...
void CSCPBase::setAETitle(const OFString &aetitle)
{
...
void CSCPBase::setRespondWithCalledAETitle(const OFBool useCalled)
{
...
OFCondition CSCPBase::loadAssociationCfgFile(const OFString &assocFile)
{
...
OFCondition CSCPBase::setAndCheckAssociationProfile(const OFString &profileName)
{
...
void CSCPBase::setConnectionBlockingMode(const DUL_BLOCKOPTIONS blockingMode)
{
...
void CSCPBase::setDIMSEBlockingMode(const T_DIMSE_BlockingMode blockingMode)
{
...
void CSCPBase::setDIMSETimeout(const Uint32 dimseTimeout)
{
...
void CSCPBase::setACSETimeout(const Uint32 acseTimeout)
{
...
void CSCPBase::setConnectionTimeout(const Uint32 timeout)
{
...
void CSCPBase::setVerbosePCMode(const OFBool mode)
{
...
void CSCPBase::setHostLookupEnabled(const OFBool mode)
{
...
void CSCPBase::setProgressNotificationMode(const OFBool mode)
{
...
void CSCPBase::setAlwaysAcceptDefaultRole(const OFBool enabled)
{
...
OFBool CSCPBase::getRefuseAssociation() const
{
...
Uint32 CSCPBase::getMaxReceivePDULength() const
{
...
const OFString &CSCPBase::getAETitle() const
{
...
OFBool CSCPBase::getRespondWithCalledAETitle() const
{
...
DUL_BLOCKOPTIONS CSCPBase::getConnectionBlockingMode() const
{
...
T_DIMSE_BlockingMode CSCPBase::getDIMSEBlockingMode() const
{
...
Uint32 CSCPBase::getDIMSETimeout() const
{
...
Uint32 CSCPBase::getConnectionTimeout() const
{
...
Uint32 CSCPBase::getACSETimeout() const
{
...
OFBool CSCPBase::getVerbosePCMode() const
{
...
OFBool CSCPBase::getHostLookupEnabled() const
{
...
OFBool CSCPBase::getProgressNotificationMode() const
{
...
OFBool CSCPBase::isConnected() const
{
...
OFString CSCPBase::getPeerAETitle() const
{
	if (m_assoc == NULL)
		return "";
...
OFString CSCPBase::getCalledAETitle() const
{
	if (m_assoc == NULL)
		return "";
...
Uint32 CSCPBase::getPeerMaxPDULength() const
{
	if (m_assoc == NULL)
		return 0;
...
T_ASC_Association * CSCPBase::GetAssociationInstance()
{
	if (m_assoc)
	{
		return m_assoc;
...
OFString CSCPBase::getPeerIP() const
{
	if (m_assoc == NULL)
		return "";
...
void CSCPBase::dropAndDestroyAssociation()
{
...
void CSCPBase::notifyAssociationRequest(const T_ASC_Parameters &params,
...
OFBool CSCPBase::checkCalledAETitleAccepted(const OFString& /*calledAETitle*/)
{
	return OFTrue;
}
...
OFBool CSCPBase::checkCallingAETitleAccepted(const OFString& /*callingAETitle*/)
{
	return OFTrue;
}
...
OFBool CSCPBase::checkCallingHostAccepted(const OFString& /*hostOrIP*/)
{
	return OFTrue;
}
...
void CSCPBase::notifyAssociationAcknowledge()
{
	DCMNET_DEBUG("CSCPBase: Association Acknowledged");
}

// ----------------------------------------------------------------------------

void CSCPBase::notifyReleaseRequest(T_DIMSE_Command CommandField)
{
...
void CSCPBase::notifyAbortRequest()
{
...
void CSCPBase::notifyAssociationTermination()
{
	DCMNET_DEBUG("CSCPBase: Association Terminated");
}

// ----------------------------------------------------------------------------

void CSCPBase::notifyConnectionTimeout()
{
...
void CSCPBase::notifyDIMSEError(const OFCondition &cond)
{
	OFString tempStr;
...
OFBool CSCPBase::stopAfterCurrentAssociation()
{
	return OFFalse;
}
...
OFBool CSCPBase::stopAfterConnectionTimeout()
{
	return OFFalse;
}
...
void CSCPBase::callbackSENDProgress(void *callbackContext,
	const unsigned long byteCount)
{
	if (callbackContext != NULL)
		OFreinterpret_cast(CSCPBase *, callbackContext)->notifySENDProgress(byteCount);
}


void CSCPBase::callbackRECEIVEProgress(void *callbackContext,
	const unsigned long byteCount)
{
	if (callbackContext != NULL)
		OFreinterpret_cast(CSCPBase *, callbackContext)->notifyRECEIVEProgress(byteCount);
}
...
OFBool CSCPBase::getPresentationContextInfo(const T_ASC_Association *assoc,
	const Uint8 presID,
	DcmPresentationContextInfo &presInfo)
{
	if (assoc != NULL)

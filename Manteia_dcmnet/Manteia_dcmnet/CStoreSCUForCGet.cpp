...
CStoreSCUForCGet::CStoreSCUForCGet():
...
CStoreSCUForCGet::TransferEntry::TransferEntry(const OFFilename &filename,
...
CStoreSCUForCGet::TransferEntry::TransferEntry(DcmDataset *dataset,
...
CStoreSCUForCGet::TransferEntry::~TransferEntry()
{
...
void CStoreSCUForCGet::TransferEntry::Init()
{
...
unsigned long CStoreSCUForCGet::getAssociationCounter() const
{
	return AssociationCounter;
}


size_t CStoreSCUForCGet::getNumberOfSOPInstances() const
{
	return TransferList.size();
}


size_t CStoreSCUForCGet::getNumberOfSOPInstancesToBeSent() const
{
...
CStoreSCUForCGet::E_DecompressionMode CStoreSCUForCGet::getDecompressionMode() const
{
	return DecompressionMode;
}


OFBool CStoreSCUForCGet::getHaltOnInvalidFileMode() const
{
	return HaltOnInvalidFileMode;
}


OFBool CStoreSCUForCGet::getHaltOnUnsuccessfulStoreMode() const
{
	return HaltOnUnsuccessfulStoreMode;
}


OFBool CStoreSCUForCGet::getAllowIllegalProposalMode() const
{
	return AllowIllegalProposalMode;
}


OFBool CStoreSCUForCGet::getReadFromDICOMDIRMode() const
{
	return ReadFromDICOMDIRMode;
}


OFBool CStoreSCUForCGet::getMOVEOriginatorInfo(OFString &aeTitle,
...
void CStoreSCUForCGet::setDecompressionMode(const E_DecompressionMode decompressionMode)
{
	DecompressionMode = decompressionMode;
}


void CStoreSCUForCGet::setHaltOnInvalidFileMode(const OFBool haltMode)
{
	HaltOnInvalidFileMode = haltMode;
}


void CStoreSCUForCGet::setHaltOnUnsuccessfulStoreMode(const OFBool haltMode)
{
	HaltOnUnsuccessfulStoreMode = haltMode;
}


void CStoreSCUForCGet::setAllowIllegalProposalMode(const OFBool allowMode)
{
	AllowIllegalProposalMode = allowMode;
}


void CStoreSCUForCGet::setReadFromDICOMDIRMode(const OFBool readMode)
{
	ReadFromDICOMDIRMode = readMode;
}


void CStoreSCUForCGet::setMOVEOriginatorInfo(const OFString &aeTitle,
...
void CStoreSCUForCGet::resetSentStatus(const OFBool sameAssociation)
{
...
void CStoreSCUForCGet::removeAllSOPInstances()
{
...
OFCondition CStoreSCUForCGet::removeSOPInstance(const OFString &sopClassUID,
	const OFString &sopInstanceUID,
...
OFCondition CStoreSCUForCGet::addDicomFile(const OFFilename &filename,
	const E_FileReadMode readMode,
...
OFCondition CStoreSCUForCGet::addDataset(DcmDataset *dataset,
...
OFCondition CStoreSCUForCGet::addDicomFilesFromDICOMDIR(const OFFilename &filename,
	const E_FileReadMode readMode,
	const OFBool checkValues)
{
...
OFCondition CStoreSCUForCGet::addPresentationContexts()
{
...
OFCondition CStoreSCUForCGet::negotiateAssociation()
{
	OFCondition status = CSCUBase::negotiateAssociation();
...
OFCondition CStoreSCUForCGet::sendSOPInstances()
{
	OFCondition status = EC_Normal;
	// check whether there are any instances in the transfer list
	if (!TransferList.empty())
...
void CStoreSCUForCGet::notifySOPInstanceToBeSent(const TransferEntry & /*transferEntry*/)
{
	// do nothing in the default implementation
}


void CStoreSCUForCGet::notifySOPInstanceSent(const TransferEntry & /*transferEntry*/)
{
	// do nothing in the default implementation
}


OFBool CStoreSCUForCGet::shouldStopAfterCurrentSOPInstance()
{
...
void CStoreSCUForCGet::getStatusSummary(OFString &summary) const
{
...
OFCondition CStoreSCUForCGet::createReportFile(const OFString &filename) const
{
	OFCondition status = EC_Normal;
	if (!filename.empty())
	{
...
OFCondition CStoreSCUForCGet::checkSOPInstance(const OFString &sopClassUID,
	const OFString &sopInstanceUID,
	const OFString &transferSyntaxUID,
	const OFBool checkValues)
{
